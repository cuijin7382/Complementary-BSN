...
def main():
    ...
    # args.add_argument('-s', '--session_name', default='MYAPBSN_DND',  type=str)
    # args.add_argument('-c', '--config',       default='APBSN_DND',  type=str)
    args.add_argument('-s', '--session_name', default='APBSN_SIDD', type=str)
    args.add_argument('-c', '--config',       default='APBSN_SIDD',  type=str)
    args.add_argument('-e', '--ckpt_epoch',   default=0,     type=int)
    args.add_argument('-g', '--gpu',          default='0',  type=str)
    args.add_argument(      '--pretrained',   default='Complementary-BSN_SIDD.pth',  type=str)
    ...
    # args.add_argument(      '--test_img',     default='./621.png',  type=str)
